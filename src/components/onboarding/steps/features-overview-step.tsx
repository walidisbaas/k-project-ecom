      ...
      <div className="glassy-card mx-auto mt-10 max-w-lg overflow-hidden rounded-2xl onboarding-stagger-2">
        <div className="divide-y divide-white/40">
          {FEATURES.map((feature) => (
            <div
              key={feature.title}
              className="flex items-start gap-4 px-5 py-5 sm:gap-5 sm:px-6 sm:py-6"
            >
              {/* Icon */}
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold text-mk-text sm:text-base">
                  {feature.title}
                ...
                <p className="mt-0.5 text-xs leading-relaxed text-mk-text-muted sm:text-sm">
                  {feature.description}
                </p>
              </div>
            </div>
