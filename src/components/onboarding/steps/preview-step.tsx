          ...
          <div className="overflow-hidden rounded-xl border border-mk-border/80 bg-white shadow-[0_1px_3px_rgba(26,18,7,0.04),0_4px_20px_rgba(26,18,7,0.06)] sm:rounded-2xl animate-in fade-in slide-in-from-bottom-4 duration-400">
            ...
            {messages.some((m) => m.role === "ai") && !thinking && (
              <div className="border-t border-mk-border/40 px-3 py-2.5 sm:px-5 sm:py-3 animate-in fade-in duration-500">
                <p className="text-center text-[10px] leading-relaxed sm:text-[11px]">
                  <span className="bg-gradient-to-r from-mk-accent to-[#C44D15] bg-clip-text font-medium text-transparent">
